    ...
    <div class="modal-movie__info">
      ...
      <ul class="modal-movie__list">
        ...
        <li class="modal-movie__item modal-movie__item--value">
          <span class="modal-movie__vote">${movie.vote_average.toFixed(1)}</span> <span>/ </span><span>${movie.vote_count}</span>
        </li>
        <li class="modal-movie__item modal-movie__item--label">popularity</li>
        <li class="modal-movie__item modal-movie__item--value"><span class="modal-movie__popularity">${movie.popularity.toFixed(1)}</span></li>
        ...
        <li class="modal-movie__item modal-movie__item--value"><span class="modal-movie__genre">${movie.genres}</span></li>
      </ul>
      ...
      <div class="modal-movie__btns">
        <div class="modal-movie__box">
          ...
          <button class="modal-movie__btn-queue" data-movie-id="${movie.id}">remove from queue</button>
        </div>
